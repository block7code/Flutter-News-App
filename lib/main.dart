...
import 'package:b7c_news/request/request.dart';
import 'package:flutter_webview_plugin/flutter_webview_plugin.dart';
import 'package:b7c_news/widget/loading_footer.dart';
import 'package:b7c_news/widget/news_item.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: HeadLinePage(title: 'B7C News'),
    );
  }
}
...
class _HeadLinePageState extends State<HeadLinePage>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
            backgroundColor: Color.fromARGB(240, 237, 165, 0),
